...
// 航空写真地図テンプレート
const ORTMapURL = "https://cyberjapandata.gsi.go.jp/xyz/seamlessphoto/{z}/{x}/{y}.jpg";
...
export class MyMap {
    ...
    //==========================================================
    startToSetTargetPseudoLatLng(ll) {
    ...
    //==========================================================
    getShadow(zoom, target, tip_height, light, camera_height, far_distance, progress) {
        return A.getShadow(this.map, zoom, target, tip_height, light, camera_height, far_distance, progress);
    }
    //////////////////////////////////////////////////////////////////////
    // 結果表示
    //==========================================================
    // 地図にドンラインを書く。
    startResult(target, line) {
        this.map.invalidateSize(true);
